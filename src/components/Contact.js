    ...
    <section id="contact">
      <ContactContainer>
        ...
        <ContactBody>
          ...
          <ContactLink href="mailto:dnsavage1@outlook.com">
            dnsavage1@outlook.com
          </ContactLink>
          . I'll also respond to messages on{" "}
          <ContactLink
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.linkedin.com/in/dnsavage/"
          >
            LinkedIn
          </ContactLink>
          . If you're not quite ready to reach out, consider taking a copy of my{" "}
          <ContactLink
            target="_blank"
            rel="noopener noreferrer"
